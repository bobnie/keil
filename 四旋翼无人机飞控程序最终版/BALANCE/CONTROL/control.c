...
//									 - PID_kpy*Roll - PID_kiy*Roll_integ - gyro[0]*PID_kdy;////////////// 
			...
			//调好的十字模式
			Moto1=PID_CONTROL - PID_kp*(Pitch+0) - gyro[1]*PID_kd - PID_ki*Pitch_integ;//平衡的PD控制  
			Moto2=PID_CONTROL + PID_kp*(Pitch+0) + gyro[1]*PID_kd + PID_ki*Pitch_integ;//可自行加入Z轴P控制抑制自旋 
